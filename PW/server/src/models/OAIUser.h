...
public:
    ...
    QList<OAIGraph> getGraphs() const;
    void setGraphs(const QList<OAIGraph> &graphs);
    bool is_graphs_Set() const;
    bool is_graphs_Valid() const;
...
private:
    ...
    QList<OAIGraph> graphs;
    bool m_graphs_isSet;
    bool m_graphs_isValid;
};
