...
void OAIUser::initializeModel() {
    ...
    m_graphs_isSet = false;
    m_graphs_isValid = false;
}
...
void OAIUser::fromJsonObject(QJsonObject json) {
    ...
    m_graphs_isValid = ::OpenAPI::fromJsonValue(graphs, json[QString("graphs")]);
    m_graphs_isSet = !json[QString("graphs")].isNull() && m_graphs_isValid;
}
...
QJsonObject OAIUser::asJsonObject() const {
    ...
    if (graphs.size() > 0) {
        obj.insert(QString("graphs"), ::OpenAPI::toJsonValue(graphs));
    }
    return obj;
}
...
QList<OAIGraph> OAIUser::getGraphs() const {
    return graphs;
}
void OAIUser::setGraphs(const QList<OAIGraph> &graphs) {
    this->graphs = graphs;
    this->m_graphs_isSet = true;
}

bool OAIUser::is_graphs_Set() const{
    return m_graphs_isSet;
}

bool OAIUser::is_graphs_Valid() const{
    return m_graphs_isValid;
}
